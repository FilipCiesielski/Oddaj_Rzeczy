...
const spanFundation = <p className={"selectText"}>Nori grape silver beet broccoli kombu beet greans fava bean potato quandong celery. Nori grape silver beet broccoli kombu beet greans fava bean potato quandong celery . </p>;
const spanOrganisation = <p className={"selectText"}>Bunya nuts black-eyed pea prairie turnip leek lentil turnip greens parsnip. Nori grape silver beet broccoli kombu beet greans fava bean potato quandong celery .</p>;
const spanLocal = <p className={"selectText"}>Bunya nuts black-eyed pea. Nori grape silver beet broccoli kombu. Nori grape silver beet broccoli kombu beet greans fava bean potato quandong celery . </p>;
...
class Organisation extends Component{
    ...
    handleOnButtonOrganisation=()=>{
        this.setState({border2:"buttonBorder",border1:"",border3:"",foundation:false,organisation:true,local:false})
    }
    handleOnButtonLocal=()=>{
        this.setState({border3:"buttonBorder",border1:"",border2:"",foundation:false,organisation:false,local:true})
    }
    render() {
